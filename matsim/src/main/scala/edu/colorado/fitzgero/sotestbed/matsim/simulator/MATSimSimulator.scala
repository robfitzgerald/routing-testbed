...
//
///**
//  * performs [[HandCrankedSimulator]] on a MATSim simulation using a MATSim configuration
//  * and without overriding route planning. use to run MATSim's UE-converging genetic-algorithmic
//  * route choice model to find UE equilibrium.
//  *
//  */
