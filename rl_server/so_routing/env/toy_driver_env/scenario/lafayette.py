...
MEAN_DELAY_DISTANCE = (MAX_TRIP_DISTANCE - MEAN_TRIP_DISTANCE) / 20

Lafayette = Scenario(
    name="Lafayette, CO",
    free_flow_drivers_threshold=100,
    half_speed_drivers_threshold=300,
    ...
    zones_of_control=300,
    zones_coverage_percent=1.0
)
